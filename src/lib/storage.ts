...
export function getMockupMonthBudget(monthKey: string = '2026-09'): MonthlyBudget {
  ...
  return {
    ...
    expenses: [
      { id: `exp_${monthKey}_1`, title: 'Aylık Büyük Market (Metro)', amount: 5450, categoryId: 'market', personId: p1, date: `${monthKey}-01`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_2`, title: 'Kasap & Şarküteri Alışverişi', amount: 2800, categoryId: 'kasap', personId: p2, date: `${monthKey}-02`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_3`, title: 'Haftalık Semt Pazarı & Yeşillik', amount: 850, categoryId: 'pazar_manav', personId: p1, date: `${monthKey}-03`, paymentMethod: 'nakit', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_4`, title: 'Araç Benzin Dolumu (Opet)', amount: 2150, categoryId: 'ulasim', personId: p2, date: `${monthKey}-04`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_5`, title: 'Eczane & Vitamin Takviyesi', amount: 920, categoryId: 'saglik', personId: p1, date: `${monthKey}-05`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_6`, title: 'Aile Hafta Sonu Akşam Yemeği', amount: 2400, categoryId: 'yemek', personId: p2, date: `${monthKey}-06`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_7`, title: 'Ev Temizlik & Yaşam Malzemeleri', amount: 1150, categoryId: 'ev_esya', personId: pHome, date: `${monthKey}-07`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_8`, title: 'Haftalık Ara Market (Migros)', amount: 1850, categoryId: 'market', personId: p1, date: `${monthKey}-08`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_9`, title: 'Üniversite Hazırlık & Kitaplar', amount: 1650, categoryId: 'egitim', personId: p3, date: `${monthKey}-10`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_10`, title: 'Spor Salonu Aylık Fitness', amount: 2200, categoryId: 'saglik', personId: p3, date: `${monthKey}-12`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_11`, title: 'Kedi Maması & Kum (Odin)', amount: 1350, categoryId: 'diger', personId: pHome, date: `${monthKey}-15`, paymentMethod: 'kredi_karti', note: 'Mama stoku yapıldı', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_12`, title: 'Dışarıda Kahve & Tatlı', amount: 680, categoryId: 'yemek', personId: p3, date: `${monthKey}-18`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_13`, title: 'Kışlık Ayakkabı & Mont', amount: 3950, categoryId: 'giyim', personId: p2, date: `${monthKey}-20`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_14`, title: 'Manav & Taze Meyve Alışverişi', amount: 550, categoryId: 'pazar_manav', personId: p1, date: `${monthKey}-24`, paymentMethod: 'nakit', createdAt: new Date().toISOString() },
      { id: `exp_${monthKey}_15`, title: 'Araç Şehir İçi Yakıt', amount: 1900, categoryId: 'ulasim', personId: p2, date: `${monthKey}-28`, paymentMethod: 'kredi_karti', createdAt: new Date().toISOString() },
    ],
  };
}
