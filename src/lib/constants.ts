...
export const DEFAULT_PERSONS: Person[] = [
  { id: 'tulay', name: 'Tülay (Anne)', role: 'Anne', color: 'bg-rose-100 text-rose-700 border-rose-200', avatar: '👩' },
  { id: 'caner', name: 'Caner (Baba)', role: 'Baba', color: 'bg-blue-100 text-blue-700 border-blue-200', avatar: '👨' },
  { id: 'can', name: 'Can', role: 'Can', color: 'bg-emerald-100 text-emerald-700 border-emerald-200', avatar: '👦' },
...
export const DEFAULT_FIXED_TEMPLATES = [
  ...
  { title: 'Cep Telefonu (Tülay)', expectedAmount: 0, categoryId: 'fatura', personId: 'tulay', dueDate: 22 },
  { title: 'Cep Telefonu (Caner)', expectedAmount: 0, categoryId: 'fatura', personId: 'caner', dueDate: 22 },
];
