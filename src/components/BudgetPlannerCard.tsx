      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-5 shadow-xs">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-zinc-100 dark:border-zinc-800">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-zinc-900 dark:text-zinc-100">Aylık Harcama Limiti & Hedef Bütçe</h2>
              <p className="text-xs text-zinc-500 dark:text-zinc-400">Bu ay için koyduğunuz tavan harcama sınırı</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            {isEditingLimit ? (
              ...
              >
                <div>
                  <span className="text-[10px] text-zinc-500 dark:text-zinc-400 uppercase font-semibold block">Tavan Hedef</span>
        ...
        <div className="pt-4 space-y-3">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 text-xs">
            <span className="font-semibold text-zinc-700 dark:text-zinc-300">
              Harcanan: <strong className="text-zinc-900 dark:text-zinc-100 font-bold">{formatCurrency(totalExpense)}</strong>
            </span>
            ...
            <span className="font-semibold text-zinc-700 dark:text-zinc-300">
              Kalan Serbest: <strong className={remainingBudget >= 0 ? 'text-emerald-700 dark:text-emerald-400 font-bold' : 'text-rose-600 dark:text-rose-400 font-bold'}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 shadow-xs flex flex-col justify-between">
          ...
          <div className="mt-4 p-3.5 bg-indigo-50/70 dark:bg-indigo-950/30 border border-indigo-100 dark:border-indigo-900/40 rounded-xl flex items-center justify-between">
            <div>
              <span className="text-[11px] font-semibold text-indigo-900 dark:text-indigo-300 block">Kalan {daysRemaining} Gün İçin:</span>
              <span className="text-2xl font-black text-indigo-700 dark:text-indigo-400">
                ~{dailySafeSpend.toLocaleString('tr-TR')} ₺ <span className="text-xs font-normal text-indigo-600 dark:text-indigo-400">/ gün</span>
              </span>
            </div>
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-4 shadow-xs flex flex-col justify-between">
          ...
          <div className="mt-4 p-3.5 bg-emerald-50/70 dark:bg-emerald-950/30 border border-emerald-100 dark:border-emerald-900/40 rounded-xl flex items-center justify-between">
            <div>
              <span className="text-[11px] font-semibold text-emerald-900 dark:text-emerald-300 block">Şu Anki Net Tasarruf:</span>
            ...
            <div className="text-right">
              <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block font-medium">Tasarruf Oranı</span>
