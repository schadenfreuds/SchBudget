        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-950/60 font-semibold text-emerald-900 dark:text-emerald-300">
                {filteredList.length}
              </span>
            </div>
            <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5">
              {t('incomes.totalIncome')}: <strong className="text-zinc-800 dark:text-zinc-200">{formatMoney(totalIncome)}</strong>
            </p>
          </div>
        </div>
